...
// display a list of favourite hero's
async function displayFavHeros(){
  ...
  for(let i = 0; i < favs.length; i++){
    ...
    let url = `https://superheroapi.com/api.php/3306871969584088/${favs[i]}`
    // The fetch() in JS is used to request to the server and load the information on the webpages.
